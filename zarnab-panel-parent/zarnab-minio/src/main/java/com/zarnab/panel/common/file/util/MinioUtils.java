package com.zarnab.panel.common.file.util;
...
//                    new BASE64Decoder().decodeBuffer(base64.trim());
    ...
    @SneakyThrows
    public String getPresignedVideoUrl(String bucketName, String objectName) {
        Map<String, String> headers = Map.of("response-content-type", "video/mp4");
        GetPresignedObjectUrlArgs args = GetPresignedObjectUrlArgs.builder()
                .bucket(bucketName)
                .object(objectName)
                .method(Method.GET)
    ...
    @SneakyThrows
    public String getPresignedVideoUrl(String bucketName, String objectName, int expires) {
        Map<String, String> headers = Map.of("response-content-type", "video/mp4");
        GetPresignedObjectUrlArgs args = GetPresignedObjectUrlArgs.builder()
                .bucket(bucketName)
                .object(objectName)
    ...
    @SneakyThrows
    public String getDownloadOnlyUrl(String bucketName, String objectName, int expire) {
        Map<String, String> headers = Map.of("response-content-disposition", "attachment");
        GetPresignedObjectUrlArgs args = GetPresignedObjectUrlArgs.builder()
                .bucket(bucketName)
                .object(objectName)
                .method(Method.GET)
